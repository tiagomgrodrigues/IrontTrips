...
function NorthAmerica() {
  const handleMouseOver = (event) => {
    ...
    // Set the tooltip's position near the mouse cursor
  ...
  return (
    <div>
      <div className="teste">
        <div className="continents-titles">
          <h2>
            North America<span className="dot">.</span>
          </h2>
